...
if(isset($_POST["submit"])){
    ...
    $sql = "INSERT INTO `student_info`(`student_id`, `last_name`, `first_name`, `gender`, `age`, `contact_number`, `email`, `department`, `major`, `year`) 
    VALUES ('$student_id','$last_name','$first_name','$gender','$age','$contact_number','$email','$department','$major','$year')";
        ...
        <div class="container d-flex justify-content-center">
            <form action="" method="post" style="width:25vw; min-width:300px;">
                ...
                <div class="col">
                    ...
                    <input type="text" class="form-control" name="student_id" placeholder="XX-XXXXX">
                </div>
